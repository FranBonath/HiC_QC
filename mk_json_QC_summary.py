...
parser.add_argument('-PTstats', help='pairtools statistics output file []-PT.stats.txt')
args = parser.parse_args()

# extract sample name from file name
sample_name = re.split("PT.stats.txt", args.PTstats)[0]
...
with open(args.PTstats, 'r') as pt_stats_info:
    for line in pt_stats_info:
        ...
        pt_stats_dict[attrb_stats_info[0]] = int(attrb_stats_info[1])
